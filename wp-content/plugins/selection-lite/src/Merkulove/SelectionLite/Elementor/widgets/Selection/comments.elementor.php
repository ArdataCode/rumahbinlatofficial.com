 ...
 **/
class comments_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    public function get_name() {
        ...
        return 'mdp-widgeter-comments-elementor';
    ...
    public function get_title() {
        ...
        return esc_html__( 'Comments', 'selection-lite' );
    ...
    public function get_icon() {
        ...
        return 'mdp-comments-elementor-widget-icon';
    ...
    private function section_content_general() {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'enable_comments_title_icon' => 'yes'
                ]
            ]
        );

        $this->add_control(
            'comments_icon_position',
            [
        ...
        $this->add_control(
            'number_of_comments',
            [
                'label' => esc_html__( 'Number of comments', 'selection-lite' ),
    ...
    private function section_style_title() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-comments-title' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'comments_title_icon_spacing',
            [
        ...
        $this->generate_typography_tabs_controls( 'section_style_title', [
            'html_class' => 'mdp-widgeter-comments-title',
            'typography_class' => 'mdp-widgeter-comments-title',
            'additional_color' => true,
            'additional_color_name' => 'Icon color',
            'additional_color_class' => 'mdp-widgeter-elementor-title-icon',
            'additional_color_hover_class' => 'mdp-widgeter-comments-title:hover .mdp-widgeter-elementor-title-icon',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-elementor-title-icon',
            'color_class' => 'mdp-widgeter-comments-title',
            'color_hover_class' => 'mdp-widgeter-comments-title:hover',
        ] );
    ...
    private function section_style_list() {
        ...
        $this->generate_margin_padding_controls(
            'section_style_list',
            'mdp-widgeter-comments-elementor-box ul'
        );

        $this->add_control(
            'comments_list_style_type',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-comments-elementor-box ul' => 'list-style-type: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->generate_typography_tabs_controls( 'section_style_list', [
            'html_class' => 'mdp-widgeter-comments-elementor-box ul',
    ...
    private function section_style_list_item() {
        ...
        $this->generate_margin_padding_controls(
            ...
            'mdp-widgeter-comments-elementor-box ul li'
        );

        $this->generate_typography_tabs_controls( 'section_style_list_item', [
            'html_class' => 'mdp-widgeter-comments-elementor-box ul li',
            'typography_class' => 'mdp-widgeter-comments-elementor-box ul li a',
            'color_class' => 'mdp-widgeter-comments-elementor-box ul li a, {{WRAPPER}} .mdp-widgeter-comments-elementor-box ul li',
            'color_hover_class' => 'mdp-widgeter-comments-elementor-box ul li:hover a,{{WRAPPER}} .mdp-widgeter-comments-elementor-box ul li:hover',
        ] );
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['comments_title_tag'] );
       $alignment_class = 'mdp-widgeter-elementor-list-align-' . esc_attr( $settings['comments_list_alignment'] );
       $icon_enabled = $settings['enable_comments_title_icon'] === 'yes';

        $default_widget_args = Caster::get_instance()->widgeter_get_widget_default_args(
       'comments',
            $title_tag,
            $icon_enabled,
            $settings['comments_title_icon'],
            $settings['comments_icon_position'],
            $alignment_class
        );

         the_widget( 'WP_Widget_Recent_Comments', [
             'title' => esc_html__( $settings['comments_title'], 'selection-lite' ),
             'number' => esc_attr( $settings['number_of_comments']['size'] )
         ], $default_widget_args  );
