 ...
 **/
class pages_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    public function get_name() {
        ...
        return 'mdp-widgeter-pages-elementor';
    ...
    public function get_title() {
        ...
        return esc_html__( 'Pages', 'selection-lite' );
    ...
    public function get_icon() {
        ...
        return 'mdp-pages-elementor-widget-icon';
    ...
    private function section_content_general() {
        ...
        $this->add_control(
            'pages_sort_by',
            [
                'label' => esc_html__( 'Sort by', 'selection-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'post_title',
                'options' => [
                    'post_title'  => esc_html__( 'Title', 'selection-lite' ),
                    'post_date' => esc_html__( 'Date', 'selection-lite' ),
                    'ID' => esc_html__( 'Id', 'selection-lite' ),
                    'menu_order' => esc_html__( 'Page order', 'selection-lite' )
                ]
            ]
        );

        $pages = get_posts( [ 'post_type' => 'page', 'post_status' => 'publish', 'ignore_sticky_posts' => 1, 'numberposts' => -1 ] );

        $this->add_control(
            'exclude_pages',
            [
                'label' => esc_html__( 'Exclude pages', 'selection-lite' ),
                'label_block' => true,
    ...
    private function section_style_title() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-pages-title' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'pages_title_icon_spacing',
            [
        ...
        $this->generate_typography_tabs_controls( 'section_style_title', [
            'html_class' => 'mdp-widgeter-pages-title',
            'typography_class' => 'mdp-widgeter-pages-title',
            'additional_color' => true,
            'additional_color_name' => 'Icon color',
            'additional_color_class' => 'mdp-widgeter-elementor-title-icon',
            'additional_color_hover_class' => 'mdp-widgeter-pages-title:hover .mdp-widgeter-elementor-title-icon',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-elementor-title-icon',
            'color_class' => 'mdp-widgeter-pages-title',
            'color_hover_class' => 'mdp-widgeter-pages-title:hover',
        ] );
    ...
    private function section_style_list() {
        ...
        $this->generate_margin_padding_controls(
            'section_style_list',
            'mdp-widgeter-pages-elementor-box ul'
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-pages-elementor-box ul' => 'list-style-type: {{VALUE}};',
                ],
            ]
        );

        $this->generate_typography_tabs_controls( 'section_style_list', [
            'html_class' => 'mdp-widgeter-pages-elementor-box ul',
    ...
    private function section_style_list_item() {
        ...
        $this->generate_margin_padding_controls(
            ...
            'mdp-widgeter-pages-elementor-box .page_item'
        );

        $this->generate_typography_tabs_controls( 'section_style_list_item', [
            'html_class' => 'mdp-widgeter-pages-elementor-box .page_item',
            'typography_class' => 'mdp-widgeter-pages-elementor-box .page_item a',
            'color_class' => 'mdp-widgeter-pages-elementor-box .page_item a, {{WRAPPER}} .mdp-widgeter-pages-elementor-box .page_item',
            'color_hover_class' => 'mdp-widgeter-pages-elementor-box .page_item:hover a, {{WRAPPER}} .mdp-widgeter-pages-elementor-box .page_item:hover',
        ] );
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['pages_title_tag'] );
       $alignment_class = 'mdp-widgeter-elementor-list-align-' . esc_attr( $settings['pages_list_alignment'] );
       $exclude_pages = !empty( $settings['exclude_pages'] ) ? implode( ',', $settings['exclude_pages'] ) : '';
       $icon_enabled = $settings['enable_pages_title_icon'] === 'yes';

        $default_widget_args = Caster::get_instance()->widgeter_get_widget_default_args(
       'pages',
            $title_tag,
            $icon_enabled,
            $settings['pages_title_icon'],
            $settings['pages_icon_position'],
            $alignment_class
        );

         the_widget( 'WP_Widget_Pages', [
             'title' => esc_html__( $settings['pages_title'], 'selection-lite' ),
