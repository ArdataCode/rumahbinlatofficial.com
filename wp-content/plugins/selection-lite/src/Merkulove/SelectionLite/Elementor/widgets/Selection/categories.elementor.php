 ...
 **/
class categories_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    public function get_name() {
        ...
        return 'mdp-widgeter-categories-elementor';
    ...
    public function get_title() {
        ...
        return esc_html__( 'Categories', 'selection-lite' );
    ...
    public function get_icon() {
        ...
        return 'mdp-categories-elementor-widget-icon';
    ...
    private function tab_style() {
        ...
        /** Style -> Section Style List Category Children. */
        $this->section_style_list_category_children();

        /** Style -> Section Style List Item. */
        $this->section_style_list_item();
    ...
    private function section_content_general() {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'enable_categories_title_icon' => 'yes'
                ]
            ]
        );

        $this->add_control(
            'categories_icon_position',
            [
	    ...
	    $this->add_control(
		    'display_as_dropdown',
		    [
			    'label' => esc_html__( 'Display as dropdown', 'selection-lite' ),
			    'type' => Controls_Manager::SWITCHER,
			    'return_value' => 'yes',
			    'default' => 'no',
		    ]
        ...
        $this->add_control(
		    'show_categories_posts_count',
		    [
			    'label' => esc_html__( 'Show posts count', 'selection-lite' ),
			    'type' => Controls_Manager::SWITCHER,
			    'return_value' => 'yes',
			    'default' => 'no',
		    ]
        ...
        $this->add_control(
		    'show_categories_hierarchy',
		    [
			    'label' => esc_html__( 'Show hierarchy', 'selection-lite' ),
			    'type' => Controls_Manager::SWITCHER,
			    'return_value' => 'yes',
			    'default' => 'no',
		    ]
    ...
    private function section_style_title() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-categories-title' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'categories_title_icon_spacing',
            [
        ...
        $this->generate_typography_tabs_controls( 'section_style_title', [
            'html_class' => 'mdp-widgeter-categories-title',
            'typography_class' => 'mdp-widgeter-categories-title',
            'additional_color' => true,
            'additional_color_name' => 'Icon color',
            'additional_color_class' => 'mdp-widgeter-elementor-title-icon',
            'additional_color_hover_class' => 'mdp-widgeter-categories-title:hover .mdp-widgeter-elementor-title-icon',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-elementor-title-icon',
            'color_class' => 'mdp-widgeter-categories-title',
            'color_hover_class' => 'mdp-widgeter-categories-title:hover',
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style List.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_list() {

        $this->start_controls_section( 'section_style_list', [
            'label' => esc_html__( 'List', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_list',
            'mdp-widgeter-categories-elementor-box ul'
        );

        $this->add_control(
            'categories_list_style_type',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-categories-elementor-box ul' => 'list-style-type: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-elementor-box nav > ul' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->generate_typography_tabs_controls( 'section_style_list', [
            'html_class' => 'mdp-widgeter-categories-elementor-box nav > ul',
     ...
     * @return void
     **/
    private function section_style_list_category_children() {

        $this->start_controls_section( 'section_style_list_category_children', [
            'label' => esc_html__( 'List category children', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE,
            'condition' => [
                'show_categories_hierarchy' => 'yes'
            ]
        ] );

        $this->generate_margin_padding_controls(
            'section_style_list_category_children',
            'mdp-widgeter-categories-elementor-box .children'
        );

        $this->add_control(
            'category_children_list_style_type',
            [
                'label' => esc_html__( 'List style type', 'selection-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'disc',
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-categories-elementor-box .children' => 'list-style-type: {{VALUE}};',
                ],
            ]
        );

        $this->add_control(
            'list_category_children_width',
            [
                'label' => esc_html__( 'Width', 'selection-lite' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-elementor-box .children' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->generate_typography_tabs_controls( 'section_style_list_category_children', [
            'html_class' => 'mdp-widgeter-categories-elementor-box .children',
            'include_typography' => false,
            'include_color' => false,
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style List Item.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_list_item() {

        $this->start_controls_section( 'section_style_list_item', [
            'label' => esc_html__( 'List item', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_list_item',
            'mdp-widgeter-categories-elementor-box ul li'
        );

        $this->generate_typography_tabs_controls( 'section_style_list_item', [
            'html_class' => 'mdp-widgeter-categories-elementor-box ul li',
            'typography_class' => 'mdp-widgeter-categories-elementor-box ul li a',
            'color_class' => 'mdp-widgeter-categories-elementor-box ul li a, {{WRAPPER}} .mdp-widgeter-categories-elementor-box ul li',
            'color_hover_class' => 'mdp-widgeter-categories-elementor-box ul li:hover a, {{WRAPPER}} .mdp-widgeter-categories-elementor-box ul li:hover',
        ] );
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['categories_title_tag'] );
       $alignment_class = 'mdp-widgeter-elementor-list-align-' . esc_attr( $settings['categories_list_alignment'] );
       $icon_enabled = $settings['enable_categories_title_icon'] === 'yes';

        $default_widget_args = Caster::get_instance()->widgeter_get_widget_default_args(
       'categories',
            $title_tag,
            $icon_enabled,
            $settings['categories_title_icon'],
            $settings['categories_icon_position'],
            $alignment_class
        );

         the_widget( 'WP_Widget_Categories', [
             'title' => esc_html__( $settings['categories_title'], 'selection-lite' ),
             'count' => $settings['show_categories_posts_count'] === 'yes',
             'dropdown' => $settings['display_as_dropdown'] === 'yes',
             'hierarchical' => $settings['show_categories_hierarchy'] === 'yes'
         ], $default_widget_args  );
