 ...
 **/
class meta_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    public function get_name() {
        ...
        return 'mdp-widgeter-meta-elementor';
    ...
    public function get_title() {
        ...
        return esc_html__( 'Meta', 'selection-lite' );
    ...
    public function get_icon() {
        ...
        return 'mdp-meta-elementor-widget-icon';
    ...
    private function section_style_title() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-meta-title' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'meta_title_icon_spacing',
            [
        ...
        $this->generate_typography_tabs_controls( 'section_style_title', [
            'html_class' => 'mdp-widgeter-meta-title',
            'typography_class' => 'mdp-widgeter-meta-title',
            'additional_color' => true,
            'additional_color_name' => 'Icon color',
            'additional_color_class' => 'mdp-widgeter-elementor-title-icon',
            'additional_color_hover_class' => 'mdp-widgeter-meta-title:hover .mdp-widgeter-elementor-title-icon',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-elementor-title-icon',
            'color_class' => 'mdp-widgeter-meta-title',
            'color_hover_class' => 'mdp-widgeter-meta-title:hover',
        ] );
    ...
    private function section_style_list() {
        ...
        $this->generate_margin_padding_controls(
            'section_style_list',
            'mdp-widgeter-meta-elementor-box ul'
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-meta-elementor-box ul' => 'list-style-type: {{VALUE}};',
                ],
            ]
        );

        $this->generate_typography_tabs_controls( 'section_style_list', [
            'html_class' => 'mdp-widgeter-meta-elementor-box ul',
    ...
    private function section_style_list_item() {
        ...
        $this->generate_margin_padding_controls(
            ...
            'mdp-widgeter-meta-elementor-box ul li'
        );

        $this->generate_typography_tabs_controls( 'section_style_list_item', [
            'html_class' => 'mdp-widgeter-meta-elementor-box ul li',
            'typography_class' => 'mdp-widgeter-meta-elementor-box ul li a',
            'color_class' => 'mdp-widgeter-meta-elementor-box ul li a, {{WRAPPER}} .mdp-widgeter-meta-elementor-box ul li',
            'color_hover_class' => 'mdp-widgeter-meta-elementor-box ul li:hover a, {{WRAPPER}} .mdp-widgeter-meta-elementor-box ul li:hover',
        ] );
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['meta_title_tag'] );
       $alignment_class = 'mdp-widgeter-elementor-list-align-' . esc_attr( $settings['meta_list_alignment'] );
       $icon_enabled = $settings['enable_meta_title_icon'] === 'yes';

        $default_widget_args = Caster::get_instance()->widgeter_get_widget_default_args(
      'meta',
            $title_tag,
            $icon_enabled,
            $settings['meta_title_icon'],
            $settings['meta_icon_position'],
            $alignment_class
        );

         the_widget( 'WP_Widget_Meta', [
             'title' => esc_html__( $settings['meta_title'], 'selection-lite' ),
         ], $default_widget_args  );
