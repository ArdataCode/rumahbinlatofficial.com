...
class rss_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['rss_title_tag'] );
       $alignment_class = 'mdp-widgeter-elementor-list-align-' . esc_attr( $settings['rss_feed_list_alignment'] );
       $icon_enabled = $settings['enable_rss_title_icon'] === 'yes';
       ...
       'rss-feed',
            $title_tag,
            $icon_enabled,
            $settings['rss_title_icon'],
            $settings['rss_icon_position'],
            $alignment_class
        );

         the_widget( 'WP_Widget_RSS', [
             'title' => esc_html__( $settings['rss_feed_title'], 'widgeter-elementor' ),
             'url' => esc_url( $settings['rss_feed_url']['url'] ),
             'items' => esc_attr( $settings['rss_feed_items_display']['size'] ),
