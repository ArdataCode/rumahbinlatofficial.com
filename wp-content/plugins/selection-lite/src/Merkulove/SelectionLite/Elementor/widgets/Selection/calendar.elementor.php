 ...
 **/
class calendar_elementor extends Widget_Base {
  ...
  'mdp-widgeter-elementor-admin',
    ...
    public function get_name() {
        ...
        return 'mdp-widgeter-calendar-elementor';
    ...
    public function get_title() {
        ...
        return esc_html__( 'Calendar', 'selection-lite' );
    ...
    public function get_icon() {
        ...
        return 'mdp-calendar-elementor-widget-icon';
    ...
    private function tab_style() {
        ...
        /** Style -> Section Style Month Title. */
        $this->section_style_month_title();

        /** Style -> Section Style Weekdays Block. */
        $this->section_style_weekdays_block();

        /** Style -> Section Style Weekdays Cell. */
        $this->section_style_weekdays_cell();

        /** Style -> Section Style Days Block. */
        $this->section_style_days_block();

        /** Style -> Section Style Days Cell. */
        $this->section_style_days_cell();

        /** Style -> Section Style Previous Button. */
        $this->section_style_previous_button();

        /** Style -> Section Style Next Button. */
        $this->section_style_next_button();
    ...
    private function section_content_general() {
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [
                    'enable_calendar_title_icon' => 'yes'
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Month alignment', 'selection-lite' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'selection-lite' ),
    ...
    private function generate_typography_tabs_controls( $section_id, $opts = [] ) {
        $style_opts = [
            ...
            'include_border_radius' => array_key_exists( 'include_border_radius', $opts ) ?
                $opts['include_border_radius'] : true,
        ...
        if ( $style_opts['include_typography'] ) {
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__( $style_opts['typography_name'], 'selection-lite' ),
        ...
        if ( $style_opts['additional_background'] ) {
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__( $style_opts['additional_background_name'], 'selection-lite' ),
                    'type' => Controls_Manager::COLOR,
                    'scheme' => [
                        'type' => Color::get_type(),
                        'value' => $style_opts['additional_color_scheme_default'],
        ...
        if ( $style_opts['include_border_radius'] ) {
        ...
        if ( $style_opts['include_active_tab'] ) {
            ...
            $this->start_controls_tab(
                ...
                ['label' => esc_html__( $style_opts['active_tab_name'], 'selection-lite' )]
            );
    ...
    private function section_style_title() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .mdp-widgeter-calendar-title' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'calendar_title_icon_spacing',
            [
        ...
        $this->generate_typography_tabs_controls( 'section_style_title', [
            'html_class' => 'mdp-widgeter-calendar-title',
            'typography_class' => 'mdp-widgeter-calendar-title',
            'additional_color' => true,
            'additional_color_name' => 'Icon color',
            'additional_color_class' => 'mdp-widgeter-elementor-title-icon',
            'additional_color_hover_class' => 'mdp-widgeter-calendar-title:hover .mdp-widgeter-elementor-title-icon',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-elementor-title-icon',
            'color_class' => 'mdp-widgeter-calendar-title',
            'color_hover_class' => 'mdp-widgeter-calendar-title:hover',
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Month Title.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_month_title() {

        $this->start_controls_section( 'section_style_month_title', [
            'label' => esc_html__( 'Month title', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_month_title',
            'mdp-widgeter-calendar-elementor-box caption'
        );

        $this->generate_typography_tabs_controls( 'section_style_month_title', [
            'html_class' => 'mdp-widgeter-calendar-elementor-box caption',
            'typography_class' => 'mdp-widgeter-calendar-elementor-box caption',
            'color_class' => 'mdp-widgeter-calendar-elementor-box caption',
            'color_hover_class' => 'mdp-widgeter-calendar-elementor-box caption:hover',
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Weekdays Block.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_weekdays_block() {

        $this->start_controls_section( 'section_style_weekdays_block', [
            'label' => esc_html__( 'Weekdays block', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_typography_tabs_controls( 'section_style_list', [
            'html_class' => 'mdp-widgeter-calendar-elementor-box thead tr',
            'include_typography' => false,
            'include_color' => false,
            'include_border_radius' => false
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Weekdays Cell.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_weekdays_cell() {

        $this->start_controls_section( 'section_style_weekdays_cell', [
            'label' => esc_html__( 'Weekdays cell', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_weekdays_cell',
            'mdp-widgeter-calendar-elementor-box thead tr th'
        );

        $this->generate_typography_tabs_controls( 'section_style_weekdays_cell', [
            'html_class' => 'mdp-widgeter-calendar-elementor-box thead tr th',
            'typography_class' => 'mdp-widgeter-calendar-elementor-box thead tr th',
            'color_class' => 'mdp-widgeter-calendar-elementor-box thead tr th',
            'color_hover_class' => 'mdp-widgeter-calendar-elementor-box thead tr th:hover',
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Days Block.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_days_block() {

        $this->start_controls_section( 'section_style_days_block', [
            'label' => esc_html__( 'Days block', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_typography_tabs_controls( 'section_style_days_block', [
            'html_class' => 'mdp-widgeter-calendar-elementor-box tbody',
            'include_typography' => false,
            'include_color' => false,
            'include_border_radius' => false
        ] );
     ...
     * @return void
     **/
    private function section_style_days_cell() {

        $this->start_controls_section( 'section_style_days_cell', [
            'label' => esc_html__( 'Days cell', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_days_cell',
            'mdp-widgeter-calendar-elementor-box tbody td'
        );

        $this->generate_typography_tabs_controls( 'section_style_days_cell', [
            'html_class' => 'mdp-widgeter-calendar-elementor-box tbody td',
            'typography_class' => 'mdp-widgeter-calendar-elementor-box tbody td',
            'additional_color' => true,
            'additional_color_name' => 'Published post date color',
            'additional_color_class' => 'mdp-widgeter-calendar-elementor-box tbody td a',
            'additional_color_hover_class' => 'mdp-widgeter-calendar-elementor-box tbody td:hover a',
            'color_class' => 'mdp-widgeter-calendar-elementor-box tbody td',
            'color_hover_class' => 'mdp-widgeter-calendar-elementor-box tbody td:hover',
            'additional_transition_selector' => '{{WRAPPER}} .mdp-widgeter-calendar-elementor-box tbody td a'
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Previous Button.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_previous_button() {

        $this->start_controls_section( 'section_style_previous_button', [
            'label' => esc_html__( 'Previous button', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_previous_button',
            'wp-calendar-nav-prev'
        );

        $this->generate_typography_tabs_controls( 'section_style_previous_button', [
            'html_class' => 'wp-calendar-nav-prev',
            'typography_class' => 'wp-calendar-nav-prev a',
            'color_class' => 'wp-calendar-nav-prev a',
            'color_hover_class' => 'wp-calendar-nav-prev:hover a',
        ] );
    ...
    /**
     * Add widget controls: Style -> Section Style Next Button.
     *
     * @since 1.0.0
     * @access private
     *
     * @return void
     **/
    private function section_style_next_button() {

        $this->start_controls_section( 'section_style_next_button', [
            'label' => esc_html__( 'Next button', 'selection-lite' ),
            'tab'   => Controls_Manager::TAB_STYLE
        ] );

        $this->generate_margin_padding_controls(
            'section_style_next_button',
            'wp-calendar-nav-next'
        );

        $this->generate_typography_tabs_controls( 'section_style_next_button', [
            'html_class' => 'wp-calendar-nav-next',
            'typography_class' => 'wp-calendar-nav-next a',
            'color_class' => 'wp-calendar-nav-next a',
            'color_hover_class' => 'wp-calendar-nav-next:hover a',
        ] );
    ...
    protected function render() {
       ...
       $title_tag = esc_attr( $settings['calendar_title_tag'] );
       $icon_enabled = $settings['enable_calendar_title_icon'] === 'yes';

        $default_widget_args = Caster::get_instance()->widgeter_get_widget_default_args(
      'calendar',
            $title_tag,
            $icon_enabled,
            $settings['calendar_title_icon'],
            $settings['calendar_icon_position']
        );

         the_widget( 'WP_Widget_Calendar', [
             'title' => esc_html__( $settings['calendar_title'], 'selection-lite' ),
         ], $default_widget_args  );
